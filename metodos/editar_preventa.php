<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if (isset($_POST["id_cliente"]) && isset($_POST["comercial"]) && isset($_POST["id_tipo"]) 
        && isset($_POST["fecha_reunion"]) && isset($_POST["horas_previstas"]) && isset($_POST["importe"]) 
        && isset($_POST["estado"]) && isset($_POST["id_usuario"])){
