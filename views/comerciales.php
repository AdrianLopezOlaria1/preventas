            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Lista de comerciales</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="d-flex justify-content-end align-items-center gap-2">        
                        <a class="btn btn-soft-info" href="index.php?action=formComercial" style="background-color: #f93215; color: white; padding: 10px 20px; border: none; transition: all 0.3s ease; border-radius: 20px;" 
                                        onmouseover="this.style.backgroundColor='#2d9cfc'; this.style.transform='scale(1.1)';"
                                        onmouseout="this.style.backgroundColor='#f93215'; this.style.transform='scale(1)';"> Nuevo comercial</a>
                    </div>
                </div>
                <?php endif; ?>
            </div>
